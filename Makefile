...
SOURCES = ./source/algorithm.cc ./source/almost_worst_fit.cc ./source/best_fit.cc ./source/bin_pack.cc ./source/first_fit.cc ./source/next_fit.cc ./source/parser.cc ./source/worst_fit.cc ./source/bin_packing_problem.cc
